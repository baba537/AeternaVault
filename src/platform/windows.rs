...
/// The fixed drive or partition other than the system drive with the most free
/// space (removable and network drives are left out).
pub fn roomiest_secondary_fixed_drive() -> Option<PathBuf> {
