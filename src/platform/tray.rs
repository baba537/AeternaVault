...
#[cfg(windows)]
pub(crate) use imp::{TRAY_CLASS, WM_APP_ACTIVATE, WM_APP_QUIT};
...
mod imp {
    ...
    /// Sent by `aeternavault --quit` (the installer, before updating or removing).
    pub(crate) const WM_APP_QUIT: u32 = WM_APP + 4;
    const ICON_ID: u32 = 1;
