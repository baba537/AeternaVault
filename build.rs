//! Embeds the application icon and version information into `AeternaVault.exe`.
//!
...
fn main() {
    println!("cargo:rerun-if-changed=assets/icon/aeterna-vault.ico");
...
fn embed_windows_resources() {
    ...
    res.set_icon("assets/icon/aeterna-vault.ico")
